			...
			<div class="row gx-4 gx-lg-5 align-items-center">
				...
				<div class="col-md-6">
					...
					<div class="btn-group d-flex" role="group" aria-label="Basic example">
						<button id="carButton" onclick="showCarInfo()" class="btn btn-sm btn-outline-info">
						...
						<button id="transportButton" onclick="showPublicTransportInfo()" class="btn btn-sm btn-outline-primary">
...
포트폴리오
		...
		function showCarInfo() {
			...
			document.getElementById("carButton").classList.add("active");
		    document.getElementById("transportButton").classList.remove("active");
		}
		...
		function showPublicTransportInfo() {
			...
			document.getElementById("carButton").classList.remove("active");
		    document.getElementById("transportButton").classList.add("active");
		}
