...
<c:choose>
	<c:when test="${not empty sessionScope.loginInfo}">
		<span class="text-light m-2"> 
			<strong> 
				<a href="/userInfo" class="text-info">
					<c:out value="${sessionScope.loginInfo.nickname}" />
				</a>
			</strong> 님, 환영합니다.
		</span>
...
<script>
	function openLoginForm() {
		...
		var loginFormUrl = '/loginForm?returnUrl='
				+ encodeURIComponent(returnUrl);

		// 새 창 열기
		var loginWindow = window.open(loginFormUrl, '_blank',
